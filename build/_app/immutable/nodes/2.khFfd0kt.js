import{f as L,a as S,w as vt}from"../chunks/C8lB4Yry.js";import{i as Lt}from"../chunks/B-eWrcdN.js";import{O as se,b as le,s as ft,h as I,K as ce,a as de,v as y,a9 as he,r as fe,c as ue,d as Ht,e as J,i as U,a0 as pe,f as Dt,g as Yt,p as me,ao as ut,a4 as Nt,N as pt,ap as ve,ae as K,aq as Rt,ar as ge,as as we,a3 as xe,at as be,au as ye,av as _e,aw as Ee,Z as Me,W as Te,P as zt,Q as At,ax as ke,ay as He,az as Re,R as ze,aA as Ae,z as $t,I as Pt,aB as Xt,B as It,C as Ot,ad as B,D as N,G as E,F as C,A as Z,aC as q,aD as Ie}from"../chunks/CItAwhV8.js";import{a as gt,s as Ce,e as Se}from"../chunks/C1ssvtQe.js";import{b as jt,i as Le}from"../chunks/DNs2nGif.js";function De(i,t){return t}function Ye(i,t,e,a){for(var r=[],o=t.length,l=0;l<o;l++)we(t[l].e,r,!0);var h=o>0&&r.length===0&&e!==null;if(h){var m=e.parentNode;xe(m),m.append(e),a.clear(),O(i,t[0].prev,t[o-1].next)}be(r,()=>{for(var b=0;b<o;b++){var s=t[b];h||(a.delete(s.k),O(i,s.prev,s.next)),ye(s.e,!h)}})}function Ne(i,t,e,a,r,o=null){var l=i,h={flags:t,items:new Map,first:null};{var m=i;l=I?ft(ce(m)):m.appendChild(se())}I&&de();var b=null,s=!1,_=he(()=>{var d=e();return Te(d)?d:d==null?[]:Nt(d)});le(()=>{var d=y(_),p=d.length;if(s&&p===0)return;s=p===0;let v=!1;if(I){var R=fe(l)===ue;R!==(p===0)&&(l=Ht(),ft(l),J(!1),v=!0)}if(I){for(var k=null,f,M=0;M<p;M++){if(U.nodeType===8&&U.data===pe){l=U,v=!0,J(!1);break}var x=d[M],g=a(x,M);f=Wt(U,h,k,null,x,g,M,r,t,e),h.items.set(g,f),k=f}p>0&&ft(Ht())}I||$e(d,h,l,r,t,a,e),o!==null&&(p===0?b?Dt(b):b=Yt(()=>o(l)):b!==null&&me(b,()=>{b=null})),v&&J(!0),y(_)}),I&&(l=U)}function $e(i,t,e,a,r,o,l){var h=i.length,m=t.items,b=t.first,s=b,_,d=null,p=[],v=[],R,k,f,M;for(M=0;M<h;M+=1){if(R=i[M],k=o(R,M),f=m.get(k),f===void 0){var x=s?s.e.nodes_start:e;d=Wt(x,t,d,d===null?t.first:d.next,R,k,M,a,r,l),m.set(k,d),p=[],v=[],s=d.next;continue}if(Pe(f,R,M),f.e.f&ut&&Dt(f.e),f!==s){if(_!==void 0&&_.has(f)){if(p.length<v.length){var g=v[0],c;d=g.prev;var H=p[0],z=p[p.length-1];for(c=0;c<p.length;c+=1)Ct(p[c],g,e);for(c=0;c<v.length;c+=1)_.delete(v[c]);O(t,H.prev,z.next),O(t,d,H),O(t,z,g),s=g,d=z,M-=1,p=[],v=[]}else _.delete(f),Ct(f,s,e),O(t,f.prev,f.next),O(t,f,d===null?t.first:d.next),O(t,d,f),d=f;continue}for(p=[],v=[];s!==null&&s.k!==k;)s.e.f&ut||(_??(_=new Set)).add(s),v.push(s),s=s.next;if(s===null)continue;f=s}p.push(f),d=f,s=f.next}if(s!==null||_!==void 0){for(var D=_===void 0?[]:Nt(_);s!==null;)s.e.f&ut||D.push(s),s=s.next;var j=D.length;if(j>0){var W=h===0?e:null;Ye(t,D,W,m)}}pt.first=t.first&&t.first.e,pt.last=d&&d.e}function Pe(i,t,e,a){ve(i.v,t),i.i=e}function Wt(i,t,e,a,r,o,l,h,m,b){var s=(m&_e)!==0,_=(m&Ee)===0,d=s?_?K(r):Rt(r):r,p=m&ge?Rt(l):l,v={i:p,v:d,k:o,a:null,e:null,prev:e,next:a};try{return v.e=Yt(()=>h(i,d,p,b),I),v.e.prev=e&&e.e,v.e.next=a&&a.e,e===null?t.first=v:(e.next=v,e.e.next=v.e),a!==null&&(a.prev=v,a.e.prev=v.e),v}finally{}}function Ct(i,t,e){for(var a=i.next?i.next.e.nodes_start:e,r=t?t.e.nodes_start:e,o=i.e.nodes_start;o!==a;){var l=Me(o);r.before(o),o=l}}function O(i,t,e){t===null?i.first=e:(t.next=e,t.e.next=e&&e.e),e!==null&&(e.prev=t,e.e.prev=t&&t.e)}function Xe(i,t,e){var a=i==null?"":""+i;return a===""?null:a}function Oe(i,t){return i==null?null:String(i)}function je(i,t,e,a,r,o){var l=i.__className;if(I||l!==e||l===void 0){var h=Xe(e);(!I||h!==i.getAttribute("class"))&&(h==null?i.removeAttribute("class"):i.className=h),i.__className=e}return o}function St(i,t,e,a){var r=i.__style;if(I||r!==t){var o=Oe(t);(!I||o!==i.getAttribute("style"))&&(o==null?i.removeAttribute("style"):i.style.cssText=o),i.__style=t}return a}const We=Symbol("is custom element"),Ve=Symbol("is html");function Be(i,t,e,a){var r=qe(i);I&&(r[t]=i.getAttribute(t),t==="src"||t==="srcset"||t==="href"&&i.nodeName==="LINK")||r[t]!==(r[t]=e)&&(t==="loading"&&(i[He]=e),e==null?i.removeAttribute(t):typeof e!="string"&&Vt(i).includes(t)?i[t]=e:i.setAttribute(t,e))}function G(i,t,e){var a=ze,r=pt;let o=I;I&&J(!1),zt(null),At(null);try{t!=="style"&&(mt.has(i.nodeName)||!customElements||customElements.get(i.tagName.toLowerCase())?Vt(i).includes(t):e&&typeof e=="object")?i[t]=e:Be(i,t,e==null?e:String(e))}finally{zt(a),At(r),o&&J(!0)}}function qe(i){return i.__attributes??(i.__attributes={[We]:i.nodeName.includes("-"),[Ve]:i.namespaceURI===Re})}var mt=new Map;function Vt(i){var t=mt.get(i.nodeName);if(t)return t;mt.set(i.nodeName,t=[]);for(var e,a=i,r=Element.prototype;r!==a;){e=Ae(a);for(var o in e)e[o].set&&t.push(o);a=ke(a)}return t}function Fe(i){return function(...t){var e=t[0];return e.preventDefault(),i==null?void 0:i.apply(this,t)}}var Ue=L(`<style>.toc-container {
		...
		}</style>`),Ge=L('<li class="toc-item"><a> </a></li>'),Je=L('<div class="toc-container"><div class="toc-progress-container"><div class="toc-progress-bar"><div class="toc-progress-fill"></div> <div class="toc-progress-indicator"></div></div> <div class="toc-title">Contents</div> <ul class="toc-list"></ul></div></div>');function Ke(i,t){$t(t,!1);let e=K(""),a=K(0),r=K(),o=[];const l=[{id:"introduction",title:"Introduction",level:1},{id:"interactive-visualization",title:"Interactive Visualization",level:1},{id:"interactive-components",title:"Interactive Components",level:1},{id:"mathematical-notation",title:"Mathematical Notation",level:1},{id:"equations",title:"Display Equations",level:2},{id:"code-blocks",title:"Code Blocks",level:1},{id:"syntax-highlighting",title:"Syntax Highlighting",level:2},{id:"side-notes",title:"Side Notes",level:1},{id:"footnotes",title:"Footnotes & Margin Content",level:2},{id:"conclusion",title:"Conclusion",level:1}];let h,m;Pt(()=>{b(),h=()=>{s(),_()},m=()=>{_()},window.addEventListener("scroll",h,{passive:!0}),window.addEventListener("resize",m,{passive:!0}),s(),_()}),Xt(()=>{h&&window.removeEventListener("scroll",h),m&&window.removeEventListener("resize",m)});function b(){const x=document.querySelector("d-article");if(!x)return;const g=x.querySelectorAll("h1, h2, h3, h4, h5, h6");o=[],g.forEach((c,H)=>{let z=c.id;z||(z=c.textContent.toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").trim(),c.id=z);const D=c.getBoundingClientRect();o.push({id:z,element:c,offsetTop:window.pageYOffset+D.top,title:c.textContent,level:parseInt(c.tagName.charAt(1))})}),o.sort((c,H)=>c.offsetTop-H.offsetTop)}function s(){if(o.length===0)return;const x=window.pageYOffset+100;let g=o[0];for(let c=o.length-1;c>=0;c--)if(x>=o[c].offsetTop){g=o[c];break}B(e,g.id)}function _(){const x=document.querySelector("d-article");if(!x)return;const g=x.getBoundingClientRect(),c=window.pageYOffset+g.top,H=x.offsetHeight,z=window.innerHeight,D=window.pageYOffset,j=c,W=c+H-z;D<=j?B(a,0):D>=W?B(a,100):B(a,(D-j)/(W-j)*100)}function d(x){const g=document.getElementById(x);g&&g.scrollIntoView({behavior:"smooth",block:"start"})}Lt();var p=Je();gt(x=>{var g=Ue();S(x,g)});var v=N(p),R=N(v),k=N(R),f=E(k,2);C(R);var M=E(R,4);Ne(M,5,()=>l,De,(x,g)=>{var c=Ge(),H=N(c),z=N(H,!0);C(H),C(c),It(()=>{je(H,1,`toc-link level-${y(g).level??""} ${y(e)===y(g).id?"active":""}`),Ce(z,y(g).title)}),Se("click",H,Fe(()=>d(y(g).id))),S(x,c)}),C(M),C(v),C(p),jt(p,x=>B(r,x),()=>y(r)),It(()=>{St(k,`height: ${y(a)??""}%`),St(f,`top: ${y(a)??""}%`)}),S(i,p),Ot()}var Ze=vt(L('<script src="https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js"><\/script><!>',1)),Qe=L('<div class="loading-message">Loading 3D visualization...</div>'),ti=L('<div class="hero-container svelte-pz775c"><div class="info-overlay svelte-pz775c"><div class="title svelte-pz775c">A low dimensional manifold</div> <div class="instructions svelte-pz775c">LLM activations live on curves surfaces like this surface.</div> <div class="status svelte-pz775c">TBD</div></div> <div class="visual-container svelte-pz775c"><!></div></div>');function ei(i,t){$t(t,!1);let e=K(),a,r,o,l,h=0,m=0,b=0,s=0,_=0,d=0,p=!1,v=[],R,k,f,M,x,g;const c=50,H=.5;Pt(async()=>{await z(),j()}),Xt(()=>{M&&cancelAnimationFrame(M),o&&o.dispose()});async function z(){let n=0;const u=50;for(;typeof THREE>"u"&&n<u;)await new Promise(w=>setTimeout(w,100)),n++;typeof THREE>"u"&&(console.error("Three.js failed to load after 5 seconds"),await D())}async function D(){return new Promise((n,u)=>{const w=document.createElement("script");w.src="https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js",w.onload=()=>{console.log("Three.js loaded manually"),n()},w.onerror=()=>{console.error("Failed to load Three.js manually"),u()},document.head.appendChild(w)})}function j(){if(typeof THREE>"u"){console.error("Three.js not loaded");return}console.log("Initializing 3D scene..."),console.log("Container dimensions:",y(e).clientWidth,"x",y(e).clientHeight),a=new THREE.Scene,r=new THREE.PerspectiveCamera(75,y(e).clientWidth/y(e).clientHeight,.1,1e3),o=new THREE.WebGLRenderer({antialias:!0,alpha:!0}),o.setSize(y(e).clientWidth,y(e).clientHeight),o.setClearColor(0,0),o.domElement.style.width="100%",o.domElement.style.height="100%",o.domElement.style.display="block",y(e).appendChild(o.domElement);const n=new THREE.AmbientLight(16777215,.6);a.add(n);const u=new THREE.DirectionalLight(16777215,.8);u.position.set(10,10,5),a.add(u),console.log("Scene, camera, renderer, and lighting created"),W(),Bt(),r.position.set(0,8,12),r.lookAt(0,0,0),R=new THREE.Raycaster,k=new THREE.Vector2,qt(),xt(),console.log("Initialization complete")}function W(){try{x=new THREE.PlaneGeometry(c*H,c*H,c-1,c-1),g=x.attributes.position.array;for(let u=0;u<g.length;u+=3){const w=g[u],Y=g[u+1],$=Math.sin(w*.3)*Math.cos(Y*.3)*3,P=Math.sin(w*.15+Y*.15)*2,X=Math.cos(w*.6)*Math.sin(Y*.4)*1.5,Q=(Math.random()-.5)*.5;g[u+2]=$+P+X+Q}x.attributes.position.needsUpdate=!0,x.computeVertexNormals();const n=new THREE.MeshBasicMaterial({color:81231,wireframe:!0,transparent:!0,opacity:.1});l=new THREE.Mesh(x,n),l.rotation.x=-Math.PI/2,a.add(l),console.log("Landscape created successfully")}catch(n){console.error("Error creating landscape:",n)}}function Bt(){try{const n=x.attributes.position.array,u=n.length/3,w=c,Y=c,$=[];for(let T=0;T<u;T++){const A=T*3,F=n[A+2];$.push({index:T,height:F})}const P=[...$].sort((T,A)=>T.height-A.height),X=P[0].height,Q=P[P.length-1].height,bt=Q-X,yt=Q-bt*.15,_t=X+bt*.15,ot=$.filter(T=>T.height>=yt),nt=$.filter(T=>T.height<=_t),at=$.filter(T=>T.height>_t&&T.height<yt);console.log(`Found ${ot.length} peaks, ${nt.length} valleys, ${at.length} other vertices`);const Et=new Set;for(let T=0;T<100;T++){let A,F=0;do{if(T<40){const V=ot[Math.floor(Math.random()*ot.length)],st=V.index%w,lt=Math.floor(V.index/w),ct=Math.floor((Math.random()-.5)*6),dt=Math.floor((Math.random()-.5)*6),ht=Math.max(0,Math.min(w-1,st+ct));A=Math.max(0,Math.min(Y-1,lt+dt))*w+ht}else if(T<70){const V=nt[Math.floor(Math.random()*nt.length)],st=V.index%w,lt=Math.floor(V.index/w),ct=Math.floor((Math.random()-.5)*6),dt=Math.floor((Math.random()-.5)*6),ht=Math.max(0,Math.min(w-1,st+ct));A=Math.max(0,Math.min(Y-1,lt+dt))*w+ht}else A=at[Math.floor(Math.random()*at.length)].index;A=Math.max(0,Math.min(u-1,A)),F++}while(Et.has(A)&&F<20);F>=20&&(A=Math.floor(Math.random()*u)),Et.add(A);const rt=A*3,Mt=n[rt],Tt=n[rt+1],kt=n[rt+2],ne=new THREE.SphereGeometry(.12,8,8),ae=new THREE.MeshBasicMaterial({color:15622778,transparent:!0,opacity:.9}),tt=new THREE.Mesh(ne,ae);tt.position.set(Mt,Tt,kt),tt.userData={id:v.length,x:Mt.toFixed(2),z:Tt.toFixed(2),height:kt.toFixed(2),vertexIndex:A},v.push(tt),l.add(tt)}console.log("Surface points created successfully:",v.length),console.log("Distribution: 40 peaks, 30 valleys, 30 other areas")}catch(n){console.error("Error creating surface points:",n)}}function qt(){o.domElement.addEventListener("mousedown",Gt),o.domElement.addEventListener("mousemove",Jt),o.domElement.addEventListener("mouseup",Kt),o.domElement.addEventListener("mousemove",Ft),o.domElement.addEventListener("touchstart",Zt),o.domElement.addEventListener("touchmove",Qt),o.domElement.addEventListener("touchend",te),window.addEventListener("resize",ee)}function Ft(n){const u=y(e).getBoundingClientRect();k.x=(n.clientX-u.left)/u.width*2-1,k.y=-((n.clientY-u.top)/u.height)*2+1,R.setFromCamera(k,r);const w=R.intersectObjects(v);if(w.length>0){const Y=w[0];Ut(Y.object,n.clientX,n.clientY)}else wt()}function Ut(n,u,w){wt(),f=document.createElement("div"),f.className="point-tooltip",f.innerHTML=`
		...
		`;const Y=200,$=140;let P=u+15,X=w-$-10;P+Y>window.innerWidth&&(P=u-Y-15),X<0&&(X=w+15),f.style.left=P+"px",f.style.top=X+"px",y(e).appendChild(f)}function wt(){f&&(f.remove(),f=null)}function Gt(n){p=!0,h=n.clientX,m=n.clientY}function Jt(n){if(p){const u=n.clientX-h,w=n.clientY-m;s+=u*.005,b+=w*.005,b=Math.max(-Math.PI/3,Math.min(Math.PI/3,b)),h=n.clientX,m=n.clientY}}function Kt(){p=!1}function Zt(n){n.touches.length===1&&(h=n.touches[0].clientX,m=n.touches[0].clientY,p=!0)}function Qt(n){if(n.touches.length===1&&p){const u=n.touches[0].clientX-h,w=n.touches[0].clientY-m;s+=u*.005,b+=w*.005,b=Math.max(-Math.PI/3,Math.min(Math.PI/3,b)),h=n.touches[0].clientX,m=n.touches[0].clientY}}function te(){p=!1}function ee(){y(e)&&r&&o&&(r.aspect=y(e).clientWidth/y(e).clientHeight,r.updateProjectionMatrix(),o.setSize(y(e).clientWidth,y(e).clientHeight))}function xt(){M=requestAnimationFrame(xt),_+=(b-_)*.05,d+=(s-d)*.05,l.rotation.z=d,l.rotation.x=-Math.PI/2+_;const n=Date.now()*5e-4;r.position.y=8+Math.sin(n)*1,o.render(a,r)}Lt();var et=ti();gt(n=>{var u=Ze();E(Z(u)),S(n,u)});var it=E(N(et),2),ie=N(it);{var oe=n=>{var u=Qe();S(n,u)};Le(ie,n=>{typeof THREE>"u"&&n(oe)})}C(it),jt(it,n=>B(e,n),()=>y(e)),C(et),S(i,et),Ot()}var ii=L(`<h2 id="introduction">Introduction</h2> <p>Manifolds are fundamental mathematical objects that have become increasingly important 
